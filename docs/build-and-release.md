...
python3 scripts/build_candidate.py --output /tmp/svc-candidate --planned-tag v0.3.0
...
manifest must bind the exact service 0.3.0, Harness 0.6.2, and Memory 0.5.2 release-unit wheels,
